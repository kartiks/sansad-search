  ...
  api/
    ...
    services/
      ...
      search.py                  # Meilisearch filter construction, result formatting,
                                 # snippet post-processing (F05 cropLength=200 ≥200-word
