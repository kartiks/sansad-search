...
|---|---------|----------------------|--------------|-----------|
| F01 | Data Ingestion | One-time bulk pipeline fetching CA (constitutionofindia.net HTML), LS (eparlib.sansad.in + IA fallback), and RS (sansad.in/rs + IA + rsdebate.nic.in) records into the search index | none | rate limiting, storage, processing time, resumability |
