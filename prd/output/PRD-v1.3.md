...
*Generated: 2026-05-30 | PRD v1.3 | Changes from v1.2: F01 LS format corrected (HTML and PDF → Pre-OCR plain text + PDF); source_url canonical-citation rule extended to RS-via-IA records (rsdebate.nic.in as canonical RS URL); new edge case for RS-via-IA records with no derivable DSpace handle.*
