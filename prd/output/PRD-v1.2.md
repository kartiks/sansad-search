...
- **Rate limiting:** ingestion must comply with robots.txt on source sites; minimum inter-request delay to be specified at architecture stage → flag in NFR
...
*Generated: 2026-05-30 | PRD v1.2 | Changes from v1.1: F01 data sources corrected (CA→constitutionofindia.net HTML; LS→eparlib.sansad.in primary + IA fallback; RS→sansad.in/rs primary + IA + rsdebate.nic.in fallback); CA OCR edge case removed; source_url LS/IA canonical URL rule added; Objective 5 generalised; INF-RL1 hosts updated; INF-P2 (OCR) removed.*
